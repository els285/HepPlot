...
class Ratio_Plot(HEP_Plot):
    ...
    def Make_Plot(self):
        ...
        # hep.atlas.text(ax=ax,text='Internal',loc=1)
...
def main():
    ...
    # print(H_mu_pt.Norm_Hist.__dict__)
    # exit()
    ...
    # exit()
    x = Ratio_Plot("plot1",design="CMS",list_of_histograms=[H_mu_pt,H_mu_E],divisor=H_mu_E)
